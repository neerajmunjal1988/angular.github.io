...
var CareerComponent = /** @class */ (function () {
    ...
    CareerComponent.prototype.unameErrors = function () {
        return this.careerForm.controls['uname'].hasError('required') ? "Name is required field" : '';
    };
    CareerComponent.prototype.onSubmit = function (frm) {
...
var ContactUsComponent = /** @class */ (function () {
    function ContactUsComponent(_http, el) {
        this._http = _http;
        this.el = el;
        this.txtfname = '';
        this.txtlname = '';
    ...
    ContactUsComponent.prototype.onSubmit = function () {
        var e = new FormData(this.el.nativeElement.querySelector('form'));
        e.append('caseno', btoa('2'));
        console.log(e);
        this._http.post('https://webmitr.com/PROJECTS/Test3/school-shopee/mail.php', e).subscribe(function (result) { return console.log(result); }, function (err) { return console.log(err); }, function () { return console.log('success'); });
    };
...
var IAmASchoolComponent = /** @class */ (function () {
    function IAmASchoolComponent() {
    }
    IAmASchoolComponent.prototype.ngOnInit = function () {
    };
...
var IAmAStudentComponent = /** @class */ (function () {
    function IAmAStudentComponent() {
    }
    IAmAStudentComponent.prototype.ngOnInit = function () {
    };
